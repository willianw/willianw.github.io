...
image: "/img/posts/2019-07-19-political-compass-a-tutorial-for-data-science/cover.png"
tags: ["politics"]
---
...
![Agenda]({% include img_path.html a=page.path p="agenda.png" %})
...
![Session]({% include img_path.html a=page.path p="session.png" %})
...
![Matter]({% include img_path.html a=page.path p="matter.png" %})
...
![Start Requests]({% include img_path.html a=page.path p="start_requests.png" %})
...
![Parse Agenda]({% include img_path.html a=page.path p="parse_agenda.png" %})
...
![Votes from each party]({% include img_path.html a=page.path p="votes_from_each_party.png" %})
...
![Votes Over Time]({% include img_path.html a=page.path p="votes_over_time.png" %})
...
![Votes Over Time Normalized]({% include img_path.html a=page.path p="votes_over_time_normalized.png" %})
...
![PCA Example]({% include img_path.html a=page.path p="pca_example.png" %})
...
![Matrix Correlation]({% include img_path.html a=page.path p="correlation_matrix.png" %})
...
![Modified Matrix Correlation]({% include img_path.html a=page.path p="modified_correlation_matrix.png" %})
...
![Meme]({% include img_path.html a=page.path p="meme.jpeg" %})
...
![PCA1]({% include img_path.html a=page.path p="pca1.png" %})

![PCA2]({% include img_path.html a=page.path p="pca2.png" %})
...
![BBC]({% include img_path.html a=page.path p="bbc.jpeg" %})
...
![Votes by Senate Table]({% include img_path.html a=page.path p="votes_by_senator_table.png" %})
...
![XGBoost]({% include img_path.html a=page.path p="xgboost.png" %})
...
![Confusion Matrix]({% include img_path.html a=page.path p="confusion_matrix.png" %})
...
![Most Important Projects]({% include img_path.html a=page.path p="most_important_projects.png" %})
